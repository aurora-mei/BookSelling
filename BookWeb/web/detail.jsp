...
<div class="container-fluid py-5">
    ...
    %>
            ...
            <div class="d-flex mb-3">
                <p class="text-dark font-weight-medium mb-0 mr-3">Category:</p>${category.categoryName}                    
            </div>
            <div class="d-flex mb-3">
...
request.setAttribute("author",(Model.Author)o);
                ...
                <div class="tab-pane fade" id="tab-pane-3">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="mb-4">1 review for "${book.title}"</h4>
...
<%@ include file="/detail_includes/productDetail.jsp" %>
