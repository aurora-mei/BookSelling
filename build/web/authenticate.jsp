                ...
                <c:when test="${fn:contains(nameJSP,'loginForm')}">
                    <form action="Authenticate" method="get">
                        ...
                        <input type="submit" value="Login">
                         <a href="https://accounts.google.com/o/oauth2/auth?scope=profile%20email%20openid&redirect_uri=http://localhost:8080/BBBB/LoginGoogleHandler&response_type=code
