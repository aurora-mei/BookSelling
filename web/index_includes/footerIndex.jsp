<%-- 
    Document   : footerIndex
    Created on : Jul 5, 2024, 1:17:57 AM
    Author     : THANH HUYEN
--%>
    ...
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">Kittens</span>Bookstore</h1>
            </a>
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-dark mb-2" href="BookAction?action=filter&by=none"><i class="fa fa-angle-right mr-2"></i>Our Shop</a>
                        <a class="text-dark mb-2" href="BookAction?action=bookShoppingImg&imgURL=images/sale1.jpg"><i class="fa fa-angle-right mr-2"></i>Shop Detail</a>
                        <a class="text-dark mb-2" href="BookAction?action=viewCart"><i class="fa fa-angle-right mr-2"></i>Shopping Cart</a>
                        <a class="text-dark mb-2" href="BookAction?action=viewOrder"><i class="fa fa-angle-right mr-2"></i>Orders</a>
