                ...
                <div class="col-lg-6 col-6 text-left">
                    <form onsubmit="event.preventDefault(); searchByKeyWord();">
                        <div class="input-group">
                            <c:choose>
                                <c:when test="${keyw != null}">
                                    <input type="text" class="form-control"
                                           placeholder="Search books by title,year publish,description"
                                           value="${keyw}">
                                </c:when>
                                <c:otherwise>
                                    <input type="text" class="form-control"
                            ...
                            <div onclick="searchByKeyWord()" class="input-group-append"
                            ...
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        <a href="BookAction?action=viewCart" class="dropdown-item active">Shopping
                                            Cart</a>
