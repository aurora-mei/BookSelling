<%-- Document : checkCheckout Created on : Jul 4, 2024, 3:20:07 AM Author : THANH HUYEN --%>
            ...
            <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                        ...
                        <div class="col-lg-8">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="shipto" data-toggle="collapse"
                                                data-target="#shipping-address">Ship to new address</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="collapse mb-4" id="shipping-address">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label>Street</label>
                                        <input class="form-control" type="text" placeholder="123 Main St" name='street'>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label>Building No</label>
                                        <input class="form-control" type="text" placeholder="Apt 4B" name='buildingNo'>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label>City</label>
                                    ...
                                    <div class="card-footer border-secondary bg-transparent">
                                        <button onclick='newAddress()'
                                            class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Save
                                            Address</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <select name="ship-method" style='width:120px;'>
                                            <c:forEach var="ship" items="${sessionScope.shipList}">
                                                <option id='${ship.shippingMethodID}' value='${ship.cost}'>
                                                    ${ship.methodName}</option>
                                            </c:forEach>
                                        </select>
                                                ...
                                                <c:choose>
                                                    <c:when test="${payment.paymentMethodID==1}">
                                                        <input type="radio" name="payment"
                                                            ...
                                                            value="${payment.paymentName}" checked>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <input type="radio" name="payment"
                                                            id="${payment.paymentMethodID}"
                ...
                <script>
                    ...
                    function newAddress() {
                        ...
                        var street = $('input[placeholder="123 Main St"]').val();
                        var buildingNo = $('input[placeholder="Apt 4B"]').val();
                        var city = $('input[placeholder="New York"]').val();
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if(response==="fill first"){
                                    alert('Fill all field of new address first!');
                                }else{
